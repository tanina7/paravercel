...
// Magia para cargar librerías de PDF
...
export default function VerificarDocumentoPage() {
  ...
  const codigoTramite = params?.codigo as string;
  ...
  const handleDescargarPDF = async () => {
    ...
    try {
      ...
      pdf.save(`Verificacion_${codigoTramite}.pdf`);
    } catch (error) {
  ...
  if (error || !tramite) {
    return (
      <div className="flex flex-col justify-center items-center h-screen space-y-4 bg-gray-50 px-4 text-center">
        ...
        <button onClick={() => router.push('/')} className="mt-6 bg-gray-900 text-white px-6 py-3 rounded-lg font-bold hover:bg-gray-800 transition-colors">
          Volver al Inicio
        </button>
      </div>
    );
    ...
    <>
      <style dangerouslySetInnerHTML={{__html: `
        @media print {
          ...
          #certificado-pantalla { position: absolute !important; left: 0 !important; top: 0 !important; margin: 0 !important; padding: 0 !important; border: none !important; box-shadow: none !important; width: 100% !important; }
        }
      `}} />
      ...
      <div className="max-w-7xl mx-auto p-6 animate-in fade-in duration-500 bg-[#f8fafc] min-h-screen">
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="w-full max-w-[210mm] flex justify-between items-center bg-green-800 text-green-100 text-xs font-mono py-2 px-4 rounded-t-xl print:hidden">
            <span>COPIA VERIFICADA ONLINE</span>
            <span className="flex items-center gap-1 font-bold">CÓDIGO: {codigoTramite}</span>
          </div>
            ...
            <div className="flex flex-col flex-1 px-10 py-8">
              ...
              <div className="mt-auto flex items-start gap-4">
                <div className="flex flex-col">
                  ...
                  <span className="text-[9px] font-bold mt-1 text-gray-800">Cód.: {codigoTramite}</span>
                </div>
                <div className="pt-2">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full max-w-[210mm] mt-6 justify-center print:hidden">
            ...
            <button onClick={() => router.push('/')} className="bg-gray-900 hover:bg-gray-800 text-white font-bold py-3.5 px-8 rounded-lg shadow-md transition-all flex items-center justify-center gap-2 flex-1 uppercase tracking-wider">
